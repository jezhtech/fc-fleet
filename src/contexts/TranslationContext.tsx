...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'home.subtitle': 'Book a chauffeur for your immediate travel needs or rent a car hourly for longer trips. First Class Fleet offers comfort, reliability, and affordability.',
    ...
    // Footer
    'footer.description': 'Your reliable transportation partner for chauffeur services and hourly rentals.',
    ...
    'footer.copyright': '© {year} First Class Fleet. All rights reserved. Powered by',
  },
  ar: {
    // Navigation
    'nav.home': 'الرئيسية',
    ...
    'home.subtitle': 'احجز سائقًا لاحتياجات السفر الفورية أو استأجر سيارة بالساعة للرحلات الأطول. تقدم First Class Fleet الراحة والموثوقية بأسعار معقولة.',
    ...
    // Footer
    'footer.description': 'شريكك الموثوق للنقل لخدمات السائقين والإيجار بالساعة.',
    ...
    'footer.copyright': '© {year} فيرست كلاس فليت. جميع الحقوق محفوظة. مدعوم من',
  }
};
...
export const TranslationProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <TranslationContext.Provider value={{ language, setLanguage, translate, direction }}>
      {children}
