    ...
    <DashboardLayout userType="driver">
      <div className="mb-6">
        <h1 className="text-2xl font-bold">
          Welcome to {config.title} Driver Portal
        </h1>
        <p className="text-gray-600 mt-1">
          Thank you for joining our driver team. Here's a quick guide to get you
          started.
        </p>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3 border-b pb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Review your driver profile to ensure all information is
                  correct, including your vehicle details.
                </p>
                <Button
                  variant="link"
            ...
            <div className="flex items-start gap-3 border-b pb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  When you're assigned to rides by the admin, you'll see them on
                  your dashboard. Start the ride when you arrive at the pickup
                  location.
                </p>
                <Button
                  variant="link"
            ...
            <div className="flex items-start gap-3 border-b pb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Provide excellent service to maintain a high rating. Your
                  performance affects your eligibility for premium rides.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 border-b pb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  View your ride history, earnings, and upcoming assignments in
            ...
            <div className="flex items-start gap-3 border-b pb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Monitor your earnings and update your bank details for
                  payments.
                </p>
                <Button
                  variant="link"
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 text-blue-600">
              ...
              <p className="font-medium">
                Professional appearance and behavior is required
              </p>
            </div>
          </div>
        </CardContent>
