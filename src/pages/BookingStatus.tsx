...
const BookingStatus = () => {
  ...
  const { status: statusFromState, bookingDetails, paymentDetails, error } = location.state || {};
  ...
  const displayPaymentDetails = paymentDetails || (status === 'success' ? {
    ...
    <div className="container mx-auto p-4 max-w-3xl">
      ...
      {isSuccess && displayBookingDetails && (
        <div className="bg-white rounded-lg border p-5 md:p-6 mb-6">
          <h2 className="text-xl font-semibold mb-4 flex items-center">
            <Calendar className="h-5 w-5 mr-2 text-fleet-red" />
            Booking Details
          </h2>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-700">{displayBookingDetails.vehicle?.name || "Selected Vehicle"}</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-700">{displayBookingDetails.pickupLocation?.name || "Pickup Location"}</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-700">{displayBookingDetails.dropoffLocation?.name || "Dropoff Location"}</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-700">{displayBookingDetails.date} at {displayBookingDetails.time}</p>
              </div>
            </div>
            ...
            {displayBookingDetails.duration && (
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">{displayBookingDetails.duration} hours</p>
                </div>
              </div>
            )}
          </div>
      ...
      {isSuccess && displayPaymentDetails && (
        <div className="bg-white rounded-lg border p-5 md:p-6 mb-8">
          <h2 className="text-xl font-semibold mb-4 flex items-center">
            <Banknote className="h-5 w-5 mr-2 text-fleet-red" />
            Payment Details
          </h2>
          ...
          <div className="space-y-4">
            <div className="flex justify-between border-b pb-3">
              ...
              <span className="font-medium">{displayPaymentDetails.transactionId}</span>
            </div>
            
            <div className="flex justify-between border-b pb-3">
              <span className="text-gray-600">Payment Method</span>
              <span className="font-medium">{displayPaymentDetails.paymentMethod}</span>
            </div>
            
            <div className="flex justify-between border-b pb-3">
              <span className="text-gray-600">Amount Paid</span>
              <span className="font-medium">AED {displayBookingDetails?.amount?.toFixed(2) || '68.00'}</span>
            </div>
