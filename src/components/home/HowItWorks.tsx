...
const PremiumFeatures = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-primary/5 rounded-full translate-x-1/3 -translate-y-1/2"></div>
      <div className="absolute -bottom-20 left-0 w-80 h-80 bg-gray-100 rounded-full"></div>
      <div className="absolute top-1/3 left-10 w-16 h-16 bg-primary/10 rounded-full"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
              ...
              <div className="relative bg-white rounded-xl shadow-xl overflow-hidden transition-all duration-300 group-hover:shadow-2xl group-hover:-translate-y-1 h-full">
                ...
                <div className="flex justify-center">
                  <div className="relative -top-6 w-20 h-20 rounded-full bg-white p-1.5 shadow-lg">
                    <div className="w-full h-full rounded-full bg-red-50 flex items-center justify-center text-primary">
                      {feature.icon}
                    </div>
                  </div>
                </div>
        ...
        >
          <div className="relative">
            <div className="absolute -top-8 left-0 w-20 h-20 bg-primary/10 rounded-full -z-10"></div>
            <div className="absolute -bottom-8 right-0 w-20 h-20 bg-primary/10 rounded-full -z-10"></div>

            <div className="py-4 px-6 border-l-4 border-primary bg-white rounded-r-lg shadow-md">
              <p className="text-xl text-gray-700 italic font-light">
                "The epitome of luxury transportation, crafted for those who
                value excellence."
              </p>
              <div className="mt-4 inline-flex items-center justify-center">
                <div className="h-px w-8 bg-primary"></div>
                <span className="mx-3 text-sm text-gray-500 uppercase tracking-wider font-medium">
                  {config.title}
                </span>
                <div className="h-px w-8 bg-primary"></div>
              </div>
