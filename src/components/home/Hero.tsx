...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-24 pb-10">
      ...
      {/* Red accent line */}
      <div className="absolute left-0 top-0 bottom-0 w-1 md:w-2 bg-primary z-10"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-8 leading-tight">
              The Art of <span className="text-primary">Luxury</span>{" "}
              Transportation in Dubai
            </h1>

            <p className="text-white/80 text-lg mb-8 max-w-xl">
              Experience unparalleled chauffeur services tailored for those who
              expect nothing but excellence. Your journey deserves our premium
              touch.
            </p>
              ...
              <Dialog>
                <DialogTrigger asChild>
                  <Button
                    ...
                    className="bg-primary hover:bg-primary/90 text-white font-medium text-lg px-8 py-6 rounded-none shadow-lg"
                  >
                    Book Your Chauffeur
                    <ChevronRight
