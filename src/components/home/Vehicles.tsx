...
const Vehicles = () => {
      ...
      if (response.success && response.data) {
        ...
        const vehiclePromises = response.data.map(async (vehicleData) => {
          ...
          const estimatedPrice =
            ...
            vehicleData.perKmPrice * 10 +
            vehicleData.perHourPrice * 15;
          ...
          return {
            ...
            perHourPrice: vehicleData.perHourPrice,
            images: images,
          };
        });
  ...
  const prevSlide = () => {
    ...
    setCurrentIndex((prevIndex) =>
      prevIndex === 0 ? vehicles.length - visibleCount : prevIndex - 1,
    );
  };
              ...
              >
                {vehicles.map((vehicle) => (
                  <div
                    ...
                    className="px-3"
                    style={{
                      width: `${(100 / vehicles.length) * visibleCount}%`,
                    }}
                  >
