...
const Meta: React.FC<MetaProps> = ({
  title = 'Premium Chauffeur & Luxury Car Service in UAE',
  ...
  const siteTitle = title ? `${title} | First Class Fleet` : 'First Class Fleet | Premium Chauffeur & Luxury Car Service in UAE';
